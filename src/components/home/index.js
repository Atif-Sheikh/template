          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  <FontAwesomeIcon className="fas fa-4x text-primary mb-4" icon={faGem} />
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  <FontAwesomeIcon className="fas fa-4x text-primary mb-4" icon={faLaptopCode} />
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  <FontAwesomeIcon className="fas fa-4x text-primary mb-4" icon={faGlobe} />
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  <FontAwesomeIcon className="fas fa-4x text-primary mb-4" icon={faHeart} />
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 ml-auto text-center">
                ...
                <FontAwesomeIcon className="fas fa-3x mb-3 text-muted" icon={faPhone} />
                <div>+1 (202) 555-0149</div>
              </div>
              <div className="col-lg-4 mr-auto text-center">
                {/* <i className="fas fa-envelope fa-3x mb-3 text-muted"></i> */}
                <FontAwesomeIcon className="fas fa-3x mb-3 text-muted" icon={faEnvelope} />
